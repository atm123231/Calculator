...
btAd=Button(cal,padx=30,bd=8,fg='black',font=('arial',20,'bold'),text="+",command=lambda:btnClick("+"),bg="silver").grid(row=3,column=3)

btdo=Button(cal,padx=30,bd=8,fg='black',font=('arial',20,'bold'),text=".",command=lambda:btnClick("."),bg="silver").grid(row=4,column=0)
btop=Button(cal,padx=30,bd=8,fg='black',font=('arial',20,'bold'),text="(",command=lambda:btnClick("("),bg="silver").grid(row=4,column=1)
btcl=Button(cal,padx=30,bd=8,fg='black',font=('arial',20,'bold'),text=")",command=lambda:btnClick(")"),bg="silver").grid(row=4,column=2)
bt7Sub=Button(cal,padx=30,bd=8,fg='black',font=('arial',20,'bold'),text="-",command=lambda:btnClick("-"),bg="silver").grid(row=4,column=3)

btClear=Button(cal,padx=30,bd=8,fg='black',font=('arial',20,'bold'),text="AC",command=btnClear,bg="silver").grid(row=5,column=0)
bt0=Button(cal,padx=30,bd=8,fg='black',font=('arial',20,'bold'),text="0",command=lambda:btnClick(0),bg="silver").grid(row=5,column=1)
btEquals=Button(cal,padx=90,bd=8,fg='black',font=('arial',20,'bold'),text="=",command=btnEquals,bg="silver").grid(row=5,column=2,columnspan=2)
cal.mainloop()